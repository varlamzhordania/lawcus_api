...
def connect_to_database(username, password, host, port, service_id):
    ...
    try:
        ...
        send_email(
            f"Lawcus Python Sync Failed for {client_name} - database on {get_timestamp()}",
...
def make_api_request(endpoint, params=None, base_url=None, headers=None, **kwargs):
    ...
    try:
        ...
        send_email(
            f"Lawcus Python Sync Failed for {client_name} - {endpoint} on {get_timestamp()}",
...
if __name__ == "__main__":
    ...
    if client_id and redirect_uri and client_secret:
        ...
        send_email(
            f"Lawcus Python Sync Failed for {client_name} - API credentials on {get_timestamp()}",
